...
export default function HomeSlickTwoCard(data) {      
  const { id, img, title, qty, price } = data;

  function handleAdd(dt){
    const obj = JSON.stringify(dt)
    localStorage.setItem("adddt",obj)
  }
  ...
  return (
    <Box className={Styles.slickCardTwo}>
      ...
      <Text className={Styles.slickCardTwoPopup}>DELIVERY IN 80 MINUTES</Text>
